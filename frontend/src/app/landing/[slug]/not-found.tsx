    ...
    <main className="flex min-h-screen items-center bg-slate-50">
      <Container className="max-w-2xl">
        <div className="rounded-lg border border-slate-200 bg-white p-8">
          ...
          <h1 className="mt-3 text-3xl font-semibold tracking-normal text-slate-950">This landing page is not published</h1>
          <p className="mt-4 leading-7 text-slate-600">
            Check the slug in Strapi, publish the page, or choose a published page from the preview list.
          </p>
